        ...
        activityCard.innerHTML = `
          ...
          <div class="participants-section">
            ...
            <ul class=\"participants-list\">
              ${details.participants.map(p => `<li class=\"participant-item\" data-activity=\"${name}\" data-email=\"${p}\"><span>${p}</span><button class=\"delete-participant\" type=\"button\">×</button></li>`).join('')}
            </ul>
          </div>
        `;
